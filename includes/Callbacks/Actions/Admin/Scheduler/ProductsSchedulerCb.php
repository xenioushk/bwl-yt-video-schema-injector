...
/**
 * Class for registering the products scheduler callback.
 *
 * @package KDESKADDON
 * @since: 2.1.9
 * @author: Mahbub Alam Khan
 */
class ProductsSchedulerCb {
	 ...
	 */
	private $option_id = KDESKADDON_CRON_BWL_PRODUCTS_OPTION_ID;
	...
	private function get_api_url() {
		...
		$api_url = Common::bwl_api_url() . 'wp-json/bwlapi/v1/offer';
		return $api_url;
	}
	 ...
	 * Get the API updates.
	 *
	 * @param bool $return_data Whether to return the data or not.
	 * @return mixed
	 */
	public function fetch_api_data( $return_data = false ) {
